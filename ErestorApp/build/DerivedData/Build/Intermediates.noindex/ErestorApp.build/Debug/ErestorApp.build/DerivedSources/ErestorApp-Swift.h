...
#ifndef ERESTORAPP_SWIFT_H
#define ERESTORAPP_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="ErestorApp",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

#if defined(__OBJC__)

SWIFT_CLASS("_TtC10ErestorApp13ActionHandler")
...
SWIFT_CLASS("_TtC10ErestorApp11AppDelegate")
...
@class NSEvent;
@class NSCoder;
SWIFT_CLASS("_TtC10ErestorApp14BubbleDragView")
@interface BubbleDragView : NSView
...
@class NSBundle;
SWIFT_CLASS("_TtC10ErestorApp21ChatWebViewController")
@interface ChatWebViewController : NSViewController
- (void)loadView;
...
SWIFT_CLASS("_TtC10ErestorApp19DraggableHeaderView")
@interface DraggableHeaderView : NSView
- (void)mouseDown:(NSEvent * _Nonnull)event;
- (void)mouseDragged:(NSEvent * _Nonnull)event;
- (nonnull instancetype)initWithFrame:(NSRect)frameRect OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
...
SWIFT_CLASS("_TtC10ErestorApp12KeyablePanel")
...
SWIFT_CLASS("_TtC10ErestorApp16ResizeHandleView")
